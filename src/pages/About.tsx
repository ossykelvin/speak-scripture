  ...
  return (
    <div className="app-shell flex min-h-screen w-full min-w-0 max-w-lg flex-col mx-auto">
      <header className="flex items-center gap-3 px-5 pt-6 pb-3">
        <Button variant="ghost" size="icon" className="h-11 w-11" onClick={() => navigate("/")}>
      ...
      <div className="flex-1 px-6 py-8 space-y-8">
        ...
        <div className="space-y-4 text-sm text-muted-foreground">
          ...
          <div className="bg-card border border-border rounded-lg p-4 space-y-2">
            ...
            <p className="leading-relaxed">
              Microphone access starts only after you tap the listening button. Search history stays
              in this app on your device and is not included in Android backups.
            </p>
          </div>
