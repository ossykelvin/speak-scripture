...
| Performance | APK size | Artifact inspection | Pass | 5,549,895 bytes |
...
| Android | Gradle debug build | GitHub Actions | Pass | Run `27414641339` |
...
| Android CI run | `27414641339` |
| Local repository path | `public/downloads/Speak-Scripture-v1.0-debug.apk` |
| Size | 5,549,895 bytes |
| SHA-256 | `A3325DA5AC3C2B8AB470F199986F6E3EAF5B96AB7D37CE7231CBD55BD933925C` |
