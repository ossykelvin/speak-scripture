...
| Performance | APK size | Artifact inspection | Pass | 5,548,659 bytes |
...
| Android | Gradle debug build | GitHub Actions | Pass | Run `27392587107` |
...
| Android CI run | `27392587107` |
| Local repository path | `public/downloads/Speak-Scripture-v1.0-debug.apk` |
| Size | 5,548,659 bytes |
| SHA-256 | `D2B193B5FE509F715EA5C3B43683FBE8349A89BF9721E34A14A2FED6440BAB61` |
